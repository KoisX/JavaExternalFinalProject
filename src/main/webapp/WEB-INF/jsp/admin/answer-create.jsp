            ...
            <section id="createForm">
                <form action="${pageContext.request.contextPath}/#" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-check">
                        <div class="col-md-10">
                            <%--TODO: improve layout, cause it's pretty ugly :( --%>
                            <label class="chk-lbl" for="case-sensitive">Case sensitive</label>
                            <input type="checkbox" class="form-check-input " id="case-sensitive" name="case-sensitive">
                        </div>
                    </div>
